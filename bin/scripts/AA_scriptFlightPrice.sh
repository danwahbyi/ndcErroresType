...
hIni=$2
hFin=$3
curl -XGET 'http://ibisesdata.corp.iberia.es:9200/logstash-business-ndc-checkout-traces-*/ndc-dist.flightprice.soap.2.info/_search?size=999&from=0&pretty' -u support:HtaCFjwHTZGa98Rf -d '{
