...
public class PMT_PPM_8006 {
	...
	private boolean esError8006()
	{
		try
		{
			String responseKibana = MyUtil.ejecutarShellScript("scriptADI8006.sh " + this.request + " " + this.fchIni + " " + this.fchFin);
